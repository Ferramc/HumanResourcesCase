...
En este informe abordamos tres principales análisis: los salarios, el desempeño de los empleados subdividido por género y los lugares en Estados Unidos en los que se encuentran actualmente laborando.

## **_Salarios:_**
Existen 6 principales departamentos en la empresa SRL, entre los cuales se encuentra el de Producción, donde el Técnico de Producción l y Técnico de Producción ll cuentan con los salarios más altos de la empresa, quedando en tercer lugar el Gerente de Ventas de Área en el departamento de Ventas. 
...
La empresa SRL tiene sus labores en Estados Unidos, el estado de Massachusetts cuenta con 276 empleados, Connecticut con 6 y Texas con 3. Los demás estados cuentan solamente con un empleado. 

![image](https://github.com/user-attachments/assets/29445675-dfe0-44b8-9e53-b9c684b356af)

### Para finalizar
Podemos ver que el área más rentable es la de Producción y que los principales puntos donde los trabajadores laboran son las costas o fronteras, en el centro del país no hay actividad económica de esta empresa y la mayoría de los empleados tienen buen desempeño laboral, lo que nos dice que existe un buen ambiente empresarial. 
